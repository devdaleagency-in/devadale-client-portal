import { Project, Agreement, ActivityFeed, Metrics, Deadline, Invoice, UploadedFile, ApprovalItem, TeamActivity, AppNotification } from './types';
...
export const INITIAL_NOTIFICATIONS: AppNotification[] = [
  {
    ...
    message: 'Mark Thompson submitted Homepage Hero Section Redesign for approval.',
    timestamp: '2 min ago',
    read: false,
    actionable: true,
    actor: { name: 'Mark Thompson', avatarUrl: teamAvatars.mark },
    target: 'Homepage Hero Section Redesign',
    actionType: 'approve',
  ...
  },
  {
    ...
    message: 'MSA - SwiftShop E-com Launch is pending your signature.',
    timestamp: '5 min ago',
    read: false,
    actionable: true,
    actor: { name: 'Admin User', avatarUrl: teamAvatars.alex },
    target: 'MSA - SwiftShop E-com',
    actionType: 'preview',
  ...
  },
  {
    ...
    message: 'Sarah Chen uploaded Brand_Guidelines_v3.pdf (2.4 MB) to DevDale Agency.',
    timestamp: '12 min ago',
    read: false,
    actionable: true,
    actor: { name: 'Sarah Chen', avatarUrl: teamAvatars.sarah },
    target: 'Brand_Guidelines_v3.pdf',
    actionType: 'download',
    metadata: { fileType: 'pdf', size: '2.4 MB', project: 'DevDale Agency' },
  },
  {
    id: 'notif-4',
    category: 'task',
    title: 'Task Completed',
    message: 'Mobile Responsive Check has been marked complete by Mark Thompson.',
    timestamp: '25 min ago',
    read: false,
    actionable: false,
    actor: { name: 'Mark Thompson', avatarUrl: teamAvatars.mark },
    target: 'Mobile Responsive Check',
  },
  {
    id: 'notif-5',
    category: 'message',
    title: 'New Comment',
    message: 'Sarah Chen commented on Homepage Hero Section: "The gradient transition needs a softer edge."',
  ...
  },
  {
    ...
    category: 'billing',
    title: 'Invoice Paid',
    message: 'INV-2024-001 ($24,000) from Aether Fintech has been paid.',
    timestamp: '2 hours ago',
    read: false,
    actionable: true,
    actionType: 'view',
    metadata: { amount: '$24,000', invoice: 'INV-2024-001', client: 'Aether Fintech' },
  },
  {
    id: 'notif-7',
    category: 'activity',
    title: 'Milestone Reached',
    message: 'UI Design System milestone approved — all components finalized.',
  ...
  },
  {
    ...
    message: 'Weekly metrics: 92% team productivity rate across 12 active projects.',
  ...
  },
  {
    id: 'notif-9',
    category: 'upload',
    title: 'Assets Package Shared',
    message: 'Sarah Chen shared Assets_Package.zip (45 MB) with the team.',
    timestamp: '8 hours ago',
    read: true,
    actionable: true,
    actor: { name: 'Sarah Chen', avatarUrl: teamAvatars.sarah },
    target: 'Assets_Package.zip',
    actionType: 'download',
    metadata: { fileType: 'zip', size: '45 MB', project: 'DevDale Agency' },
  },
  {
    id: 'notif-10',
    category: 'approval',
    title: 'Deliverable Approved',
    message: 'Brand Guidelines v3 Final Draft has been approved by Admin User.',
    timestamp: 'Yesterday',
    read: true,
    actionable: false,
    actor: { name: 'Admin User', avatarUrl: teamAvatars.alex },
    target: 'Brand Guidelines v3',
    metadata: { type: 'content', status: 'approved' },
  },
  {
    id: 'notif-11',
    category: 'task',
    title: 'Deadline Approaching',
    message: 'V1 Prototype Review is due today — assigned to Alex.',
    timestamp: 'Yesterday',
    read: true,
    actionable: false,
    target: 'V1 Prototype Review',
    metadata: { priority: 'high', due: 'Today' },
  },
  {
    id: 'notif-12',
    category: 'system',
    title: 'Portal Updated',
    message: 'DevDale Client Portal v2.4.0 deployed with new dashboard widgets.',
    timestamp: '2 days ago',
    read: true,
    actionable: false,
  },
